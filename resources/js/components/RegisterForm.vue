        ...
        <div class="w-full md:w-3/4 px-8 py-12">
            ...
            <form @submit.prevent="register" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" id="name" v-model="formData.name" placeholder="Full Name" 
                ...
                <div>
                    ...
                    <input type="password" id="password_confirmation" v-model="formData.password_confirmation" placeholder="Confirm Password" 
                        class="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400">
                </div>
                ...
                <p class="text-gray-600 text-xs text-left mt-2">
                    Already have an account? <a href="/login" class="text-blue-500 font-bold">Login</a>
                </p>
            </form>
            ...
            if (this.errors.length === 0) {
                ...
                .then(data => {
                    if (data.errors) {
                        ...
                        this.toast.error('There are some errors in your form. Please check and try again.');
                    } else {
                        // Success
